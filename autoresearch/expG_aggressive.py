#!/usr/bin/env python3
"""
Idea G: expD 기반 공격적 fine-tuning
- 분석: expE에서 LR=5e-8/5e-7이 너무 낮아 수렴 불충분 (val 0.9633)
- 전략: 더 높은 LR (5e-7/5e-6) + OneCycleLR + 15ep
- 동일한 Coffee/Rice x15 가중치 유지
- 동일한 데이터셋 (new class only)
"""
