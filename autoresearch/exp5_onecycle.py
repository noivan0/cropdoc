"""
Idea 5: OneCycleLR + 12 epoch
기반: exp3 모델 (val_acc_new=0.9609)
새 baseline = 0.9609, keep 기준: >= 0.9709
전략: FocalLoss 유지, LR을 OneCycleLR로 더 공격적으로 탐색
"""
...
# features.6, 7 + classifier unfreeze
...
# OneCycleLR: max_lr는 base lr의 10배
...
OUT_DIR = "data/models/cropdoc_ext_exp5"
...
print(f"\nIdea5 완료: val_acc_new={best_val:.4f}, 소요={total_time:.1f}min")
